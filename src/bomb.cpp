...
Bomb::Bomb(float x, float y, float z) {
    ...
    for (int i=0; i<9*N_TRNG; i+=9) {
        ...
        vertex_buffer_color[i+3] = 1.0f;
        vertex_buffer_color[i+4] = 0.0f;
        vertex_buffer_color[i+5] = 0.0f;

        vertex_buffer_color[i+6] = 1.0f;
    ...
    for (int i=0; i<18*N_TRNG; i+=18) {
        ...
        vertex_buffer_color[9*N_TRNG+i] = 1.0f;
        vertex_buffer_color[9*N_TRNG+i+1] = 0.0f;
        vertex_buffer_color[9*N_TRNG+i+2] = 0.0f;

        vertex_buffer_color[9*N_TRNG+i+3] = 1.0f;
        vertex_buffer_color[9*N_TRNG+i+4] = 0.0f;
        vertex_buffer_color[9*N_TRNG+i+5] = 0.0f;

        vertex_buffer_color[9*N_TRNG+i+6] = 1.0f;
        vertex_buffer_color[9*N_TRNG+i+7] = 0.0f;
        vertex_buffer_color[9*N_TRNG+i+8] = 0.0f;

        vertex_buffer_color[9*N_TRNG+9+i] = 1.0f;
        vertex_buffer_color[9*N_TRNG+9+i+1] = 0.0f;
        vertex_buffer_color[9*N_TRNG+9+i+2] = 0.0f;

        vertex_buffer_color[9*N_TRNG+9+i+3] = 1.0f;
        vertex_buffer_color[9*N_TRNG+9+i+4] = 0.0f;
        vertex_buffer_color[9*N_TRNG+9+i+5] = 0.0f;

        vertex_buffer_color[9*N_TRNG+9+i+6] = 1.0f;
        vertex_buffer_color[9*N_TRNG+9+i+7] = 0.0f;
